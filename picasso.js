...
//Page 2
            ...
            'animations' :  [
              {
                'selector'    : '.page2-byline',
                'translateY'  : '-25%',
                'opacity'     : [0, 1.75] // hack to accelrate opacity speed
              } , {
                'selector'    : '#page2Graphics',
                'translateY'  : '-90%',
                'opacity'     : [0, 1] // hack to accelrate opacity speed
              }
            ]
...
//page 3

          {
            ...
            'animations' :  [
              {
                'selector'    : '.page3-byline',
                'translateY'  : '-25%',
                'opacity'     : [0, 1.75] // hack to accelrate opacity speed
              } , {
                'selector'    : '#page3Graphics',
                'translateY'  : '-90%',
                'opacity'     : [0, 1] // hack to accelrate opacity speed
              }
            ]
...
//page 4
            ...
            'animations' :  [
              {
                'selector'    : '.page4-byline',
                'translateY'  : '-25%',
                'opacity'     : [0, 1.75] // hack to accelrate opacity speed
              } , {
                'selector'    : '#page4Graphics',
                'translateY'  : '-90%',
                'opacity'     : [0, 1] // hack to accelrate opacity speed
              }
            ]
...
///page 5
            ...
            'animations' :  [
              {
                'selector'    : '.page5-byline',
                'translateY'  : '-25%',
                'opacity'     : [0, 1.75] // hack to accelrate opacity speed
              } , {
                'selector'    : '#page5Graphics',
                'translateY'  : '-90%',
                'opacity'     : [0, 1] // hack to accelrate opacity speed
              }
            ]
